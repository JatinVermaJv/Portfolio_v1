    ...
    >
      ...
      <section className="flex flex-col items-center md:w-1/2 text-center space-y-6 md:space-y-8">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://x.com/mushashi_01" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        >
          <Link
            href="mailto:jatinverma5868@gmail.com" // Replace with your actual email
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://github.com/JatinVermaJv" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://www.linkedin.com/in/jatin-verma-09776b2b6/" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
